"""
Django settings for ent_demo_ecommerce__43309 project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites', "shopping_cart"
]
LOCAL_APPS = [
    'home',
...
ROOT_URLCONF = 'ent_demo_ecommerce__43309.urls'
...
WSGI_APPLICATION = 'ent_demo_ecommerce__43309.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ent_demo_ecommerce__43309 API",
    "DESCRIPTION": "API documentation for ent_demo_ecommerce__43309 App",
    "VERSION": "v1",
}
