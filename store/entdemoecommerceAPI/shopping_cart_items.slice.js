...
export const api_v1_shopping_cart_items_list = createAsyncThunk(
  "shopping_cart_items/api_v1_shopping_cart_items_list",
  async payload => {
    const response = await apiService.api_v1_shopping_cart_items_list(payload)
    return response.data
  }
)
export const api_v1_shopping_cart_items_create = createAsyncThunk(
  "shopping_cart_items/api_v1_shopping_cart_items_create",
  async payload => {
    const response = await apiService.api_v1_shopping_cart_items_create(payload)
    return response.data
  }
)
export const api_v1_shopping_cart_items_retrieve = createAsyncThunk(
  "shopping_cart_items/api_v1_shopping_cart_items_retrieve",
  async payload => {
    const response = await apiService.api_v1_shopping_cart_items_retrieve(
      payload
    )
    return response.data
  }
)
export const api_v1_shopping_cart_items_update = createAsyncThunk(
  "shopping_cart_items/api_v1_shopping_cart_items_update",
  async payload => {
    const response = await apiService.api_v1_shopping_cart_items_update(payload)
    return response.data
  }
)
export const api_v1_shopping_cart_items_partial_update = createAsyncThunk(
  "shopping_cart_items/api_v1_shopping_cart_items_partial_update",
  async payload => {
    const response = await apiService.api_v1_shopping_cart_items_partial_update(
      payload
    )
    return response.data
  }
)
export const api_v1_shopping_cart_items_destroy = createAsyncThunk(
  "shopping_cart_items/api_v1_shopping_cart_items_destroy",
  async payload => {
    const response = await apiService.api_v1_shopping_cart_items_destroy(
      payload
    )
    return response.data
  }
