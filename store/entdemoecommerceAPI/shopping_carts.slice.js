...
export const api_v1_shopping_cart_list = createAsyncThunk("shopping_carts/api_v1_shopping_cart_list", async payload => {
  const response = await apiService.api_v1_shopping_cart_list(payload);
  return response.data;
});
export const api_v1_shopping_cart_create = createAsyncThunk("shopping_carts/api_v1_shopping_cart_create", async payload => {
  const response = await apiService.api_v1_shopping_cart_create(payload);
  return response.data;
});
export const api_v1_shopping_cart_retrieve = createAsyncThunk("shopping_carts/api_v1_shopping_cart_retrieve", async payload => {
  const response = await apiService.api_v1_shopping_cart_retrieve(payload);
  return response.data;
});
export const api_v1_shopping_cart_update = createAsyncThunk("shopping_carts/api_v1_shopping_cart_update", async payload => {
  const response = await apiService.api_v1_shopping_cart_update(payload);
  return response.data;
});
export const api_v1_shopping_cart_partial_update = createAsyncThunk("shopping_carts/api_v1_shopping_cart_partial_update", async payload => {
  const response = await apiService.api_v1_shopping_cart_partial_update(payload);
  return response.data;
});
export const api_v1_shopping_cart_destroy = createAsyncThunk("shopping_carts/api_v1_shopping_cart_destroy", async payload => {
