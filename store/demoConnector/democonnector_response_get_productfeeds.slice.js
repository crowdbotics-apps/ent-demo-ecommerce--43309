...
export const democonnector_get_productfeedjson_list = createAsyncThunk("democonnector_response_get_productfeeds/democonnector_get_productfeedjson_list", async payload => {
  const response = await apiService.democonnector_get_productfeedjson_list(payload);
